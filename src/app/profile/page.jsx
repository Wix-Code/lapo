  ...
  <div className='flex flex-col gap-3'>
    <div className='flex items-center justify-between h-[48px] bg-[#FFFFFF] border-[#DEE6E2] border-[1px] px-5 top-0 sticky z-50'>
      <div className='flex items-center gap-4'>
        <Image src="/pics/cre.png" alt='Card Icon' height={16} width={16} />
    ...
    <div className='flex items-center justify-between px-5'>
      ...
      <div>
          <Link href="/profile/profile_card">
      ...
      <table border="1" width="100%" className='bg-[#EAECF0] sm:overflow-y-scroll'>
        <thead className='bg-[#EAECF0]'>
          <tr className='flex items-center bg-[#F9FAFB]'>
            <th className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px]'>Branch</th>
            <th className='flex-1 text-[#475467] text-[12px] py-3  border-[#E2E2E2] border-[1px]'>Initiator</th>
            <th className='flex-1 text-[#475467] text-[12px] py-3  border-[#E2E2E2] border-[1px]'>Quantity</th>
            <th className='flex-1 text-[#475467] text-[12px] py-3  border-[#E2E2E2] border-[1px]'>Batch</th>
            <th className='flex-1 text-[#475467] text-[12px]  border-[#E2E2E2] border-[1px] py-3'>Date Requested</th>
            <th className='flex-1 text-[#475467] text-[12px]  border-[#E2E2E2] border-[1px] py-3'>Status</th>
        ...
        <tbody>
          <tr className='flex items-center bg-[#FFFFFF]'>
            ...
            <td  className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>11/10/2024  23:21:03</td>
            <td className='flex-1 text-center gap-2 text-[#014DAF] font-bold text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px]'>
             View
            </td>
          </tr>
        </tbody>
        <tbody>
          <tr className='flex items-center bg-[#FFFFFF]'>
            ...
            <td className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>11/10/2024  23:21:03</td>
            <td  className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>11/10/2024  23:21:03</td>
            <td className='flex-1 text-[#014DAF] text-[12px] font-bold py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>
             View
            </td>
          </tr>
        </tbody>
        <tbody>
          <tr className='flex items-center bg-[#FFFFFF]'>
            ...
            <td className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>11/10/2024  23:21:03</td>
            <td  className='flex-1 text-[#475467] text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>11/10/2024  23:21:03</td>
            <td className='flex-1 text-[#014DAF] font-bold text-[12px] py-3 border-[#E2E2E2] border-[1px] h-[42px] text-center'>
              View
            </td>
          </tr>
        </tbody>
